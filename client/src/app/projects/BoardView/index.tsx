            ...
            <div className='mb-3 flex w-full'>
                ...
                <div className='flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary'>
                    <h3 className='flex items-center text-lg font-semibold dark:text-white'>
                        {status}{" "}
                        <span className='ml-2 inline-block rouned-full bg-gray-200 p-1 text-center text-sm leading-none dark:bg-dark-tertiary'
                    ...
                    <div className='flex items-center gap-1'>
                        ...
                        <button className='flex h-6 w-6 items-center justify-center rounde bg-gray-200 dark:bg-dark-tertiary dark:text-white'
...
const Task = ({ task }: TaskProps) => {
    ...
    return (
        <div ref={(instance) => {
            ...
            className={`mb-4 rounded-md bg-white shadow dark:bg-gray-secondary ${isDragging ? "opacity-50" : "opacity-100"
                }`}
        >
            {task.attachments && task.attachments.length > 0 && (
                <Image
                    ...
                    width={400}
                    height={200}
                    className='h-auto w-full rounde-t-md'
                />
            )}
